    ...
    <div className="settings-panel">
      <div className="s-header">
        ...
        <div className="s-header-right">
          <span
            className="s-version-num"
            onDoubleClick={() => setShowAuthor((v) => !v)}
          ...
          {showAuthor && (
            <span
              ...
              title="zengtai.net"
              onClick={() => tauriApi.openUrl("https://zengtai.net/")}
            >
              <img
      ...
      <div className="s-grid">
        <section className="s-section">
          ...
          >
            <span className="s-label" style={{ paddingTop: 6 }}>
              文件名后缀
            </span>
            <div
              className="s-ctrl"
                ...
                {[
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      const val =
                        local.output_suffix.slice(0, start) +
                        token +
                        local.output_suffix.slice(end);
